...
namespace IronRuby.Compiler.Generation {
    ...
    public abstract class ClsTypeEmitter {
        ...
        protected abstract void EmitImplicitContext(ILGenerator il);
        ...
        protected abstract void EmitClassObjectFromInstance(ILGenerator il);
        ...
        private void CallBaseConstructor(ConstructorInfo parentConstructor, ParameterInfo[] pis, ParameterInfo[] overrideParams, ILGenerator il) {
            il.EmitLoadArg(0);
#if DEBUG
            int lastIndex = -1;
#endif
        ...
        protected ILGenerator GetCCtor() {
            if (_cctor == null) {
        ...
        private void ImplementProtectedFieldAccessors() {
            ...
            foreach (FieldInfo fi in fields) {
                ...
                ILGenerator il = CreateILGen(method.GetILGenerator());
                if (!fi.IsStatic) {
                    il.EmitLoadArg(0);
                }
        ...
        /// </summary>
        private void EmitBaseMethodDispatch(MethodInfo mi, ILGenerator il) {
            if (!mi.IsAbstract) {
                int offset = 0;
                if (!mi.IsStatic) {
                    il.EmitLoadArg(0);
        ...
        private MethodBuilder CreateVTableGetterOverride(MethodInfo mi, string name) {
            MethodBuilder impl;
            ILGenerator il = DefineMethodOverride(MethodAttributes.Public, mi, out impl);
        ...
        /// </summary>
        public void EmitConvertFromObject(ILGenerator il, Type toType) {
        ...
        public void EmitVirtualSiteCall(ILGenerator il, MethodInfo mi, string name) {
        ...
        internal protected ILGenerator CreateILGen(ILGenerator il) {
        ...
        protected ILGenerator DefineMethodOverride(Type type, string name, out MethodInfo decl, out MethodBuilder impl) {
            return DefineMethodOverride(MethodAttributes.PrivateScope, type, name, out decl, out impl);
        }

        protected ILGenerator DefineMethodOverride(MethodAttributes extra, Type type, string name, out MethodInfo decl, out MethodBuilder impl) {
            decl = type.GetMethod(name);
            return DefineMethodOverride(extra, decl, out impl);
        }

        protected ILGenerator DefineMethodOverride(MethodInfo decl, out MethodBuilder impl) {
            return DefineMethodOverride(MethodAttributes.PrivateScope, decl, out impl);
        }

        protected ILGenerator DefineMethodOverride(MethodAttributes extra, MethodInfo decl, out MethodBuilder impl) {
        ...
        /// </summary>
        internal void EmitClrCallStub(ILGenerator/*!*/ il, MethodInfo/*!*/ mi, string/*!*/ name) {
            int firstArg = 0;
        ...
        private void EmitContext(ILGenerator/*!*/ il, bool context) {
            if (context) {
                il.EmitLoadArg(1);
            } else {
