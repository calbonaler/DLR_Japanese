...
namespace IronRuby.Compiler.Generation {
    internal class RubyTypeBuilder : IFeatureBuilder {
        ...
        private static void AddConstructor(List<ConstructorBuilderInfo>/*!*/ ctors, ConstructorBuilderInfo/*!*/ ctor) {
            int existing = ctors.FindIndex((c) => c.ParameterTypes.SequenceEqual(ctor.ParameterTypes));
            if (existing != -1) {
        ...
        private void DefineDynamicObjectImplementation() {
            ...
            ILGenerator il = DefinePrivateInterfaceMethodOverride(_tb, typeof(IDynamicMetaObjectProvider).GetMethod("GetMetaObject"));
            il.EmitLoadArg(0);
            il.EmitLoadArg(1);
        ...
        private void ImplementCTDOverride(MethodInfo m) {
            ...
            ILGenerator il = DefinePrivateInterfaceMethodOverride(_tb, m, out builder);
            il.EmitLoadArg(0);
        ...
        private static ILGenerator/*!*/ DefineMethodOverride(TypeBuilder/*!*/ tb, MethodInfo/*!*/ decl) {
            MethodBuilder impl;
            return DefineMethodOverride(tb, decl, out impl);
        }

        private static ILGenerator/*!*/ DefineMethodOverride(TypeBuilder/*!*/ tb, MethodInfo/*!*/ decl, out MethodBuilder/*!*/ impl) {
            impl = tb.DefineMethod(
                decl.Name,
                decl.Attributes & ~(MethodAttributes.Abstract | MethodAttributes.ReservedMask),
                decl.ReturnType,
                decl.GetParameters().Select(x => x.ParameterType).ToArray()
            );
        ...
        private static ILGenerator/*!*/ DefinePrivateInterfaceMethodOverride(TypeBuilder/*!*/ tb, MethodInfo/*!*/ decl) {
            MethodBuilder impl;
            return DefinePrivateInterfaceMethodOverride(tb, decl, out impl);
        }

        private static ILGenerator/*!*/ DefinePrivateInterfaceMethodOverride(TypeBuilder/*!*/ tb, MethodInfo/*!*/ decl, out MethodBuilder/*!*/ impl) {
