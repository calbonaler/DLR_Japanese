...
namespace IronRuby.Runtime.Calls {
    ...
    public abstract class RubyMethodGroupBase : RubyMemberInfo {
        ...
        internal OverloadInfo/*!*/[]/*!*/ SetMethodBasesNoLock(OverloadInfo/*!*/[]/*!*/ methods) {
            Debug.Assert(
                Array.TrueForAll(methods, (method) => method.IsStatic || method.DeclaringType == typeof(Object)) ||
                Array.TrueForAll(methods, (method) => !method.IsStatic || RubyUtils.IsExtension(method) || RubyUtils.IsOperator(method))
            );
        ...
        public override MemberInfo/*!*/[]/*!*/ GetMembers() {
            return MethodBases.Select(o => (MemberInfo)o.ReflectionInfo).ToArray();
        }
                ...
                for (int i = 0; i < overloads.Count; i++) {
                    ...
                    if ((isSuperCall && overload.IsVirtual && !overload.IsFinal) || overload.IsProtected) {
                        if (newOverloads == null) {
							newOverloads = new List<OverloadInfo>(i);
							for (var j = 0; j < i; j++)
								newOverloads.Add(overloads[j]);
                        ...
                        if (underlyingType != null) {
                            ...
                            OverloadInfo visibleMethod = GetMethodOverload(
                                overload.Parameters.Select(pi => pi.ParameterType).ToArray(),
                                genericArguments,
                                underlyingType,
        ...
        private static OverloadInfo/*!*/ GetMethodOverload(Type/*!*/[]/*!*/ parameterTypes, IList<Type/*!*/> genericParameterTypes,
            ...
            for (int i = 0; i < overloads.Length; i++) {
                ...
                if (overload.GetParameters().Select(pi => pi.ParameterType).SequenceEqual(parameterTypes)) {
