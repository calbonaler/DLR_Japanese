...
namespace IronRuby.Runtime {
    internal sealed class RubyStackTraceBuilder {
        ...
        internal RubyStackTraceBuilder(RubyContext/*!*/ context, int skipFrames)
            ...
            _interpretedFrames = InterpretedFrame.CurrentFrame != null ?
                new List<InterpretedFrameInfo>(InterpretedFrame.CurrentFrame.GetStackTraceDebugInfo()) :
                null;
            ...
            if (stackTrace != null) {
                foreach (var frame in InterpretedFrame.GroupStackFrames(stackTrace)) {
                    ...
                    if (_interpretedFrames != null && _interpretedFrameIndex < _interpretedFrames.Count 
                        && InterpretedFrame.IsInterpretedFrame(frame)) {
        ...
        private bool TryGetStackFrameInfo(StackFrame/*!*/ frame, out string/*!*/ methodName, out string/*!*/ fileName, out int line) {
            ...
            if (TryParseRubyMethodName(ref methodName, ref fileName, ref line)) {
                ...
                if (attrs.Length > 0) {
                    ...
                    return true;
                } else if (_exceptionDetail || IsVisibleClrFrame(method, fileName != null)) {
                    // Visible CLR method:
        ...
        private static bool IsVisibleClrFrame(MethodBase/*!*/ method, bool hasSources) {
...
#if !SILVERLIGHT
                if (type == typeof(System.Runtime.Remoting.Channels.ChannelServices) ||
                    type == typeof(System.Threading.ExecutionContext) ||
                    method.Name.EndsWith("ProcessMessage", StringComparison.Ordinal)
                        && typeof(System.Runtime.Remoting.Channels.IChannelSinkBase).IsAssignableFrom(type)) {
            ...
            return hasSources || CompilerHelpers.IsVisible(method);
        }
