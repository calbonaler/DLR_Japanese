...
namespace IronRuby.Tests {
    ...
    public partial class Tests {
        ...
        private void TraceTestLambda(Expression<Action> lambda, Action<Action> invoker) {
            ...
            Assert(compiled.SequenceEqual(interpreted));
            Assert(compiled.SequenceEqual(sync));
        }
        ...
        public void InterpreterMethodCalls1() {
            ...
            Assert(c_sg_result.SequenceEqual(i_sg_result));
            Assert(c_g_result.SequenceEqual(i_g_result));
            Assert(c_list.SequenceEqual(i_list));
        }
