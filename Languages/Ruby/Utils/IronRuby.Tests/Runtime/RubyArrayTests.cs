...
namespace IronRuby.Tests {
    public partial class Tests {
        ...
        private void AssertValueEquals(RubyArray/*!*/ array, params object[]/*!*/ expected) {
            Assert(array.ToArray().SequenceEqual(expected));
        ...
        public void RubyArray_Basic() {
            ...
            Assert(ArrayUtils.ShiftLeft(array, 1).SequenceEqual(values));
        ...
        public void RubyArray_Misc() {
            ...
            a.Sort();
            Assert(a.ToArray().SequenceEqual(new object[] { 1, 2, 3, 4, 5 }));
            a.Sort((x, y) => (int)x == (int)y ? 0 : ((int)x < (int)y ? 1 : -1));
            Assert(a.ToArray().SequenceEqual(new object[] { 5, 4, 3, 2, 1 }));
            a.Reverse();
            Assert(a.ToArray().SequenceEqual(new object[] { 1, 2, 3, 4, 5 }));
