...
#if USE_SNIPPETS
            TypeBuilder tb = Snippets.DefinePublicType("calli", typeof(object), false, false);
            MethodBuilder dm = tb.DefineMethod("calli", CompilerHelpers.PublicStatic, returnType, parameterTypes);
#else
...
#if USE_SNIPPETS
            return _calliStub = tb.CreateType().GetMethod("calli");
#else
