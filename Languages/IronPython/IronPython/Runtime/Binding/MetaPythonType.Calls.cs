...
namespace IronPython.Runtime.Binding {
    ...
    partial class MetaPythonType : MetaPythonObject, IPythonInvokable {
        ...
        private DynamicMetaObject/*!*/ InvokeWorker(DynamicMetaObjectBinder/*!*/ call, DynamicMetaObject/*!*/[]/*!*/ args, Expression/*!*/ codeContext) {
            PerfTrack.NoteEvent(PerfTrack.Category.Binding, "Type Invoke " + Value.UnderlyingSystemType.FullName + args.Length);
            PerfTrack.NoteEvent(PerfTrack.Category.BindingTarget, "Type Invoke");
            ...
            if (!Value.IsSystemType && (!(newAdapter is DefaultNewAdapter) || HasFinalizer(call))) {
                ...
                res = Expression.Dynamic(
                    ...
                    ArrayUtils.Insert(
                        ...
                        args.Select(x => x != null ? x.Expression : null).ToArray()
                    )
                );
