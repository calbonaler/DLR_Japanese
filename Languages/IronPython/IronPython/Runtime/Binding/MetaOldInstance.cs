...
namespace IronPython.Runtime.Binding {
    ...
    class MetaOldInstance : MetaPythonObject, IPythonInvokable, IPythonGetable, IPythonOperable, IPythonConvertible {        
        ...
        public override DynamicMetaObject/*!*/ BindBinaryOperation(BinaryOperationBinder/*!*/ binder, DynamicMetaObject/*!*/ arg) {
            PerfTrack.NoteEvent(PerfTrack.Category.Binding, "OldClass BinaryOperation" + binder.Operation);
            PerfTrack.NoteEvent(PerfTrack.Category.BindingTarget, "OldClass BinaryOperation");
            return PythonProtocol.Operation(binder, this, arg, null);
        }

        public override DynamicMetaObject/*!*/ BindUnaryOperation(UnaryOperationBinder/*!*/ binder) {
            PerfTrack.NoteEvent(PerfTrack.Category.Binding, "OldClass UnaryOperation" + binder.Operation);
            PerfTrack.NoteEvent(PerfTrack.Category.BindingTarget, "OldClass UnaryOperation");
            return PythonProtocol.Operation(binder, this, null);
        }

        public override DynamicMetaObject/*!*/ BindGetIndex(GetIndexBinder/*!*/ binder, DynamicMetaObject/*!*/[]/*!*/ indexes) {
            PerfTrack.NoteEvent(PerfTrack.Category.Binding, "OldClass GetIndex" + indexes.Length);
            PerfTrack.NoteEvent(PerfTrack.Category.BindingTarget, "OldClass GetIndex");
            return PythonProtocol.Index(binder, PythonIndexType.GetItem, ArrayUtils.Insert(this, indexes));
        }

        public override DynamicMetaObject/*!*/ BindSetIndex(SetIndexBinder/*!*/ binder, DynamicMetaObject/*!*/[]/*!*/ indexes, DynamicMetaObject/*!*/ value) {
            PerfTrack.NoteEvent(PerfTrack.Category.Binding, "OldClass SetIndex" + indexes.Length);
            PerfTrack.NoteEvent(PerfTrack.Category.BindingTarget, "OldClass SetIndex");
        ...
        public override DynamicMetaObject/*!*/ BindDeleteIndex(DeleteIndexBinder/*!*/ binder, DynamicMetaObject/*!*/[]/*!*/ indexes) {
            PerfTrack.NoteEvent(PerfTrack.Category.Binding, "OldClass DeleteIndex" + indexes.Length);
            PerfTrack.NoteEvent(PerfTrack.Category.BindingTarget, "OldClass DeleteIndex");
        ...
        private DynamicMetaObject/*!*/ InvokeWorker(DynamicMetaObjectBinder/*!*/ invoke, Expression/*!*/ codeContext, DynamicMetaObject/*!*/[] args) {
            PerfTrack.NoteEvent(PerfTrack.Category.Binding, "OldClass Invoke");
        ...
        private DynamicMetaObject/*!*/ MakeMemberAccess(DynamicMetaObjectBinder/*!*/ member, string name, MemberAccess access, params DynamicMetaObject/*!*/[]/*!*/ args) {
            ...
            if (key == -1) {
                PerfTrack.NoteEvent(PerfTrack.Category.Binding, "OldInstance " + access + " NoOptimized"); 
            ...
            PerfTrack.NoteEvent(PerfTrack.Category.Binding, "OldInstance " + access + " Optimized"); 
            switch (access) {
        ...
        DynamicMetaObject IPythonOperable.BindOperation(PythonOperationBinder action, DynamicMetaObject[] args) {
            PerfTrack.NoteEvent(PerfTrack.Category.Binding, "OldClass PythonOperation " + action.Operation);
