...
namespace IronPython.Runtime.Binding {
    ...
    class MetaOldClass : MetaPythonObject, IPythonInvokable, IPythonGetable, IPythonOperable, IPythonConvertible {
        ...
        public DynamicMetaObject ConvertWorker(DynamicMetaObjectBinder binder, Type toType, ConversionResultKind kind) {        
            PerfTrack.NoteEvent(PerfTrack.Category.Binding, "OldClass Convert");
            PerfTrack.NoteEvent(PerfTrack.Category.BindingTarget, "OldClass Convert");
        ...
        private DynamicMetaObject/*!*/ MakeCallRule(DynamicMetaObjectBinder/*!*/ call, Expression/*!*/ codeContext, DynamicMetaObject[] args) {
            PerfTrack.NoteEvent(PerfTrack.Category.Binding, "OldClass Invoke w/ " + args.Length + " args");
            PerfTrack.NoteEvent(PerfTrack.Category.BindingTarget, "OldClass Invoke");
        ...
        private DynamicMetaObject/*!*/ MakeSetMember(string/*!*/ name, DynamicMetaObject/*!*/ value) {
            PerfTrack.NoteEvent(PerfTrack.Category.Binding, "OldClass SetMember");
            PerfTrack.NoteEvent(PerfTrack.Category.BindingTarget, "OldClass SetMember");
            DynamicMetaObject self = Restrict(typeof(OldClass));
        ...
        private DynamicMetaObject/*!*/ MakeDeleteMember(DeleteMemberBinder/*!*/ member) {
            PerfTrack.NoteEvent(PerfTrack.Category.Binding, "OldClass DeleteMember");
            PerfTrack.NoteEvent(PerfTrack.Category.BindingTarget, "OldClass DeleteMember");
            DynamicMetaObject self = Restrict(typeof(OldClass));
        ...
        private DynamicMetaObject/*!*/ MakeGetMember(DynamicMetaObjectBinder/*!*/ member, DynamicMetaObject codeContext) {
            PerfTrack.NoteEvent(PerfTrack.Category.Binding, "OldClass GetMember");
            PerfTrack.NoteEvent(PerfTrack.Category.BindingTarget, "OldClass GetMember");
            DynamicMetaObject self = Restrict(typeof(OldClass));
