    ...
    class PythonInvokeBinder : DynamicMetaObjectBinder, IPythonSite, IExpressionSerializable {
        ...
        public override T BindDelegate<T>(CallSite<T> site, object[] args) {
            ...
            if (args[1] is Types.PythonType) {
                PerfTrack.NoteEvent(PerfTrack.Category.BindingSlow, "InvokeNoFast " + ((Types.PythonType)args[1]).Name);
            } else {
                PerfTrack.NoteEvent(PerfTrack.Category.BindingSlow, "InvokeNoFast " + CompilerHelpers.GetType(args[1]));
            }
        ...
        internal DynamicMetaObject/*!*/ Fallback(Expression codeContext, DynamicMetaObject target, DynamicMetaObject/*!*/[]/*!*/ args) {
            ...
            return PythonProtocol.Call(this, target, args) ??
                ...
                Context.Binder.Invoke(Signature, new PythonOverloadResolverFactory(Context.Binder, codeContext), target, args);
        }
