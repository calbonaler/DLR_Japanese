...
namespace IronPython.Runtime.Binding {
    ...
    class PythonGetMemberBinder : DynamicMetaObjectBinder, IPythonSite, IExpressionSerializable {
        ...
        public override T BindDelegate<T>(CallSite<T> site, object[] args) {
            ...
            if (fastGet != null) {
                ...
                if (res != null) {
                    PerfTrack.NoteEvent(PerfTrack.Category.BindingFast, "IFastGettable");
                    return res;
                }

                PerfTrack.NoteEvent(PerfTrack.Category.BindingSlow, "IFastGettable");
            ...
            if (pyObj != null && !(args[0] is IProxyObject)) {
                ...
                if (res.Target != null) {
                    PerfTrack.NoteEvent(PerfTrack.Category.BindingFast, "IPythonObject");
                    if (res.ShouldCache) {
                ...
                PerfTrack.NoteEvent(PerfTrack.Category.BindingSlow, "IPythonObject Get");
                return base.BindDelegate<T>(site, args);
            }
 ...
 !(args[0] is IDynamicMetaObjectProvider)) {
            ...
            PerfTrack.NoteEvent(PerfTrack.Category.BindingSlow, "GetNoFast " + IsNoThrow + " " + CompilerHelpers.GetType(args[0]));
            return base.BindDelegate<T>(site, args);
        }
        ...
        private Func<CallSite, TSelfType, CodeContext, object> MakeGetMemberTarget<TSelfType>(string name, object target) {
            ...
            if (typeof(TypeTracker).IsAssignableFrom(type)) {
                ...
                PerfTrack.NoteEvent(PerfTrack.Category.BindingSlow, "GetNoFast TypeTracker");
                return null;
            }
            ...
            if (members.Count == 0 && typeof(IStrongBox).IsAssignableFrom(type)) {
                ...
                PerfTrack.NoteEvent(PerfTrack.Category.BindingSlow, "GetNoFast StrongBox");
                return null;
            }
            ...
            if (getMem != null && getMem.IsSpecialName) {
                ...
                PerfTrack.NoteEvent(PerfTrack.Category.BindingSlow, "GetNoFast GetCustomMember " + type);
                return null;
            }
            ...
            if (error == null) {
                ...
                if (isHidden) {
                    PerfTrack.NoteEvent(PerfTrack.Category.BindingSlow, "GetNoFast FilteredMember " + memberType);
                    return null;
                }
                ...
                switch (memberType) {
                    ...
                    case TrackerTypes.Type:
                        ...
                        if (members.Count == 1) {
                            ...
                            for (int i = 1; i < members.Count; i++) {
                                typeTracker = TypeGroup.Merge(typeTracker, (TypeTracker)members[i]);
                            }
                            typeObj = typeTracker;
                        }
                    ...
                    case TrackerTypes.Event:
                        ...
                        PerfTrack.NoteEvent(PerfTrack.Category.BindingSlow, "GetNoFast Event " + members.Count + " " + ((EventTracker)members[0]).IsStatic);
                        return null;
                    case TrackerTypes.Property:
                        ...
                        PerfTrack.NoteEvent(PerfTrack.Category.BindingSlow, "GetNoFast Property " + members.Count + " " + ((PropertyTracker)members[0]).IsStatic);
                        return null;
                    case TrackerTypes.All:
                        getMem = Context.Binder.GetMethod(type, "GetBoundMember");
                        if (getMem != null && getMem.IsSpecialName) {
                            PerfTrack.NoteEvent(PerfTrack.Category.BindingSlow, "GetNoFast GetBoundMember " + type);
                            return null;
                        }
                    ...
                    default:
                        PerfTrack.NoteEvent(PerfTrack.Category.BindingSlow, "GetNoFast " + memberType);
                        return null;
                }
            } else {
        ...
        internal static DynamicMetaObject FallbackWorker(PythonContext context, DynamicMetaObject/*!*/ self, DynamicMetaObject/*!*/ codeContext, string name, GetMemberOptions options, DynamicMetaObjectBinder action, DynamicMetaObject errorSuggestion) {
            ...
            PerfTrack.NoteEvent(PerfTrack.Category.BindingTarget, "FallbackGet");
