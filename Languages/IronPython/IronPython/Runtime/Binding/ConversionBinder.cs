...
namespace IronPython.Runtime.Binding {
    ...
    class PythonConversionBinder : DynamicMetaObjectBinder, IPythonSite, IExpressionSerializable {
        ...
        private DynamicMetaObject BindConvert(DynamicMetaObject self) {
            PerfTrack.NoteEvent(PerfTrack.Category.Binding, "Convert " + Type.FullName + " " + self.LimitType);
            PerfTrack.NoteEvent(PerfTrack.Category.BindingTarget, "Conversion");
        ...
        public override T BindDelegate<T>(CallSite<T> site, object[] args) {
            ...
            PerfTrack.NoteEvent(PerfTrack.Category.Binding, "Convert " + Type.FullName + " " + CompilerHelpers.GetType(args[0]) + " " + typeof(T));
