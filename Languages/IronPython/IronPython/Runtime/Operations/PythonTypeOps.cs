            ...
            switch(tt) {
                ...
                case TrackerTypes.Type:
                    ...
                    for (int i = 1; i < group.Count; i++) {
                        type = TypeGroup.Merge(type, (TypeTracker)group[i]);
                    }
...
#pragma warning restore 169
            ...
            if (mems.Length != 0) {
                ...
                lock (_functions) {
                    if (!_functions.TryGetValue(cache, out res)) {
                        ...
                        _functions[cache] = res = BuiltinFunction.MakeMethod(pythonName, Array.ConvertAll<MemberInfo, MethodBase>(mems, x => (MethodBase)x), type, ft);
                    }
                }
            }
        ...
        internal static bool TryInvokeUnaryOperator(CodeContext context, object o, string name, out object value) {
            PerfTrack.NoteEvent(PerfTrack.Category.Temporary, "UnaryOp " + CompilerHelpers.GetType(o).Name + " " + name);
        ...
        internal static bool TryInvokeBinaryOperator(CodeContext context, object o, object arg1, string name, out object value) {
            PerfTrack.NoteEvent(PerfTrack.Category.Temporary, "BinaryOp " + CompilerHelpers.GetType(o).Name + " " + name);
        ...
        internal static bool TryInvokeTernaryOperator(CodeContext context, object o, object arg1, object arg2, string name, out object value) {
            PerfTrack.NoteEvent(PerfTrack.Category.Temporary, "TernaryOp " + CompilerHelpers.GetType(o).Name + " " + name);
