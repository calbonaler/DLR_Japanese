...
namespace IronPython.Runtime.Operations {
    ...
    public static partial class PythonOps {
        ...
        public static string Repr(CodeContext/*!*/ context, object o) {
            ...
            PerfTrack.NoteEvent(PerfTrack.Category.Temporary, "Repr " + o.GetType().FullName);
        ...
        public static object GetUserDescriptor(object o, object instance, object context) {
            if (o is IPythonObject) {
                ...
                PerfTrack.NoteEvent(PerfTrack.Category.DictInvoke, "__get__");
                object ret;
        ...
        public static bool TrySetUserDescriptor(object o, object instance, object value) {
            ...
            // slow, but only encountred for user defined descriptors.
            PerfTrack.NoteEvent(PerfTrack.Category.DictInvoke, "__set__");
        ...
        public static bool TryDeleteUserDescriptor(object o, object instance) {
            ...
            // slow, but only encountred for user defined descriptors.
            PerfTrack.NoteEvent(PerfTrack.Category.DictInvoke, "__delete__");
        ...
        private static TraceBack CreateTraceBack(PythonContext pyContext, Exception e) {
            ...
            for (int i = 0; i < frames.Length; i++) {
                ...
                if (pyFrame != null) {
                    ...
                    tb.SetLine(frame.FileLineNumber);
                }
            }
        ...
        private static Exception MakeExceptionWorker(CodeContext context, object type, object value, object traceback, bool forRethrow) {
            ...
            PerfTrack.NoteEvent(PerfTrack.Category.Exceptions, throwable);
        ...
        public static DynamicMetaObjectBinder MakeComplexCallAction(int count, bool list, string[] keywords) {
            Argument[] infos = System.Linq.Enumerable.ToArray(System.Linq.Enumerable.Repeat(Argument.Simple, count + keywords.Length));
            if (list) {
        ...
        public static DynamicMetaObjectBinder MakeSimpleCallAction(int count) {
            return DefaultContext.DefaultPythonContext.Invoke(
                new CallSignature(System.Linq.Enumerable.ToArray(System.Linq.Enumerable.Repeat(Argument.Simple, count)))
            );
        }
