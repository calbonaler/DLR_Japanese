...
namespace IronPython.Runtime {
    ...
    public class PythonDictionary : IDictionary<object, object>, IDictionary, IAttributesCollection,
        ...
        void IAttributesCollection.Add(object name, object value) { this[name] = value; }
        bool IAttributesCollection.TryGetValue(object name, out object value) { return ((IDictionary<object, object>)this).TryGetValue(name, out value); }
        bool IAttributesCollection.Remove(object name) { return ((IDictionary<object, object>)this).Remove(name); }
        bool IAttributesCollection.ContainsKey(object name) { return __contains__(name); }
