...
namespace IronPython.Runtime {
    ...
    internal class PythonFileManager {
        ...
        public PythonFile GetFileFromId(PythonContext context, int id) {
            ...
            switch (id) {
                ...
                case 2:
                    ...
                    break;
                default:
                    pf = fileMapping.GetObjectForId(id);
                    break;
            }
        ...
        public object GetObjectFromId(PythonContext context, int id) {
            object o = objMapping.GetObjectForId(id);
        ...
        public int GetIdFromFile(PythonFile pf) {
            ...
            int res = fileMapping.GetIdForObject(pf);
            if (res == -1) {
        ...
        public int GetIdFromObject(object o) {
            int res = objMapping.GetIdForObject(o);
            if (res == -1) {
                // lazily created weak mapping
            ...
            try {
                ...
                try {
                    if (Environment.OSVersion.Platform == PlatformID.Win32NT && name == "nul") {
                        ...
                        stream = PythonContext.GetContext(context).DomainManager.Platform.OpenFileStream(name, fmode, faccess, fshare);
                    } else {
                        stream = PythonContext.GetContext(context).DomainManager.Platform.OpenFileStream(name, fmode, faccess, fshare, buffering);
                    }
                } catch (IOException e) {
