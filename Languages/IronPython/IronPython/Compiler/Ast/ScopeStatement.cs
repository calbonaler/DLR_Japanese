    ...
    public abstract class ScopeStatement : Statement {
        ...
        internal MSAst.MethodCallExpression CreateLocalContext(MSAst.Expression parentContext) {
            ...
            return Ast.Call(
                ...
                parentContext,
                MutableTuple.Create(Array.ConvertAll(closureVariables, x => GetClosureCell(x))),
                Ast.Constant(Array.ConvertAll(closureVariables, x => x.AccessedInScope ? x.Variable.Name : null))
            );
        }
