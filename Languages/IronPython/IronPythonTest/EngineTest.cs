        ...
        class MyInvokeMemberBinder : InvokeMemberBinder {
            ...
            public override DynamicMetaObject FallbackInvoke(DynamicMetaObject target, DynamicMetaObject[] args, DynamicMetaObject errorSuggestion) {
                return new DynamicMetaObject(
                    Expression.Dynamic(new MyInvokeBinder(CallInfo), typeof(object), ArrayUtils.Insert(target, args).Select(x => x != null ? x.Expression : null)),
...
", SourceCodeKind.Statements).Execute(mod);
        ...
        public void ScenarioCP24784() {
            ...
            AreEqual(code.FetchCodeProperties(), ScriptCodeParseResult.IncompleteStatement);
        }
...
", SourceCodeKind.Statements);
        ...
        public void ScenarioAddToPath() { // runs first to avoid path-order issues            
            ...
            try {
                ...
                _pe.SearchPaths = new string[] { Common.ScriptTestDirectory };
