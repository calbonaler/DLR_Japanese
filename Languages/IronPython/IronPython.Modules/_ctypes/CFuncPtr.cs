                        ...
                        res = Expression.Dynamic(
                            ...
                            Expression.Call(
                                ...
                                Expression.NewArrayInit(
                                    typeof(object),
                                    System.Array.ConvertAll(args, x => Utils.Convert(x.Expression, typeof(object)))
                                )
                            )
                        );
                    }
...
#else
                    TypeBuilder tb = Snippets.DefinePublicType("InteropInvoker", typeof(object), false, false);
                    MethodBuilder dm = tb.DefineMethod("InteropInvoker", CompilerHelpers.PublicStatic, retType, sigTypes);
#endif
...
#if CTYPES_USE_SNIPPETS
                    return tb.CreateType().GetMethod("InteropInvoker");
#else
                    return dm;
#endif
                }
