    ...
    public static class PythonThread {
        ...
        public class _local {
            ...
            private class ThreadLocalDictionaryStorage : DictionaryStorage {
                private readonly System.Threading.ThreadLocal<CommonDictionaryStorage> _storage = new System.Threading.ThreadLocal<CommonDictionaryStorage>();
                ...
                private CommonDictionaryStorage/*!*/ GetStorage() {
					return _storage.Value ?? (_storage.Value = new CommonDictionaryStorage());
                }
            }
