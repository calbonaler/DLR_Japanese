        ...
        public class partial : IWeakReferenceable {
            ...
            public object Call(CodeContext/*!*/ context, params object[] args) {
                if (_keywordArgs == null) {
                    EnsureSplatSite();
                    return _splatSite.Target(_splatSite, context, _function, ArrayUtils.Append(_args, args));
                }

                EnsureDictSplatSite();
                return _dictSite.Target(_dictSite, context, _function, ArrayUtils.Append(_args, args), _keywordArgs);
            }
            ...
            public object Call(CodeContext/*!*/ context, [ParamDictionary]IDictionary<object, object> dict, params object[] args) {
                ...
                EnsureDictSplatSite();
                return _dictSite.Target(_dictSite, context, _function, ArrayUtils.Append(_args, args), finalDict);
            }
