    ...
    public class ComplexMath {
        ...
        public static Complex asinh(object x) {
            ...
            if (num == Complex.Zero) {
                ...
                return new Complex(0, num.Imaginary);
            }
        ...
        public static Complex sqrt(object x) {
            ...
            if (num.Imaginary == 0.0) {
                if (num.Real >= 0.0) {
                    ...
                    return new Complex(0, Math.Sqrt(-num.Real));
                }
            }

            double c = Complex.Abs(num) + num.Real;
        ...
        public static PythonTuple polar(object x) {
            ...
            double[] res = new double[] { Complex.Abs(num), GetAngle(num) };
