...
{
	[ComImport, InterfaceType(ComInterfaceType.InterfaceIsIDispatch), Guid("00020400-0000-0000-C000-000000000046")]
	...
	interface IDispatch
	{
		...
		[PreserveSig]
		int TryInvoke(int dispIdMember, ref Guid riid, int lcid, ComTypes.INVOKEKIND wFlags, ref ComTypes.DISPPARAMS pDispParams, out object VarResult, out ComTypes.EXCEPINFO pExcepInfo, out uint puArgErr);
	}

	/// <summary>IDispatch 仮想関数テーブルのレイアウトを表します。</summary>
	enum IDispatchMethodIndices
	{
